...
import { BsXDiamond, BsTrash, BsDownload } from "react-icons/bs";
import {
...
const CountryDetailComponent = () => {
    ...
    const download = async () => {
        ...
        fakeLink.download = `Details of: ${name}`;
    ...
    return (
        <div id='detail-content'>
            ...
            {/* <div className='div-button-details'>
                <button className='button-details'  onClick={download}>Descargar Datos</button>
            </div> */}
